...
package com.aftersixapps.EstudAR;
...
public class EstudAR extends Activity
{
    ...
    {   
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(EstudAR.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(EstudAR.this).create();
